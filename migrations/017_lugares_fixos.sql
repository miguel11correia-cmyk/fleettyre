...
insert into _slot_map_veiculo (num_eixos, categoria, idx, lugar) values
  ('4x2', 'Direção', 1, 'Direção Esquerda'),
  ('4x2', 'Direção', 2, 'Direção Direita'),
  ('4x2', 'Tração',  1, 'Tração Esquerda Interior'),
  ('4x2', 'Tração',  2, 'Tração Esquerda Exterior'),
  ('4x2', 'Tração',  3, 'Tração Direita Interior'),
  ('4x2', 'Tração',  4, 'Tração Direita Exterior'),
  ('6x2 Pusher', 'Direção', 1, 'Direção Esquerda'),
  ('6x2 Pusher', 'Direção', 2, 'Direção Direita'),
  ('6x2 Pusher', 'Tração',  1, 'Tração Esquerda Interior'),
  ('6x2 Pusher', 'Tração',  2, 'Tração Esquerda Exterior'),
  ('6x2 Pusher', 'Tração',  3, 'Tração Direita Interior'),
  ('6x2 Pusher', 'Tração',  4, 'Tração Direita Exterior'),
  ('6x2 Tag', 'Direção', 1, 'Direção Esquerda'),
  ('6x2 Tag', 'Direção', 2, 'Direção Direita'),
  ('6x2 Tag', 'Tração',  1, 'Tração Esquerda Interior'),
  ('6x2 Tag', 'Tração',  2, 'Tração Esquerda Exterior'),
  ('6x2 Tag', 'Tração',  3, 'Tração Direita Interior'),
  ('6x2 Tag', 'Tração',  4, 'Tração Direita Exterior');
...
insert into _slot_map_reboque (num_eixos, categoria, idx, lugar) values
  ('2x2', 'Eixo 1', 1, 'Eixo 1 Esquerda'),
  ('2x2', 'Eixo 1', 2, 'Eixo 1 Direita'),
  ('2x2', 'Eixo 2', 1, 'Eixo 2 Esquerda'),
  ('2x2', 'Eixo 2', 2, 'Eixo 2 Direita'),
  ('2x2x2', 'Eixo 1', 1, 'Eixo 1 Esquerda'),
  ('2x2x2', 'Eixo 1', 2, 'Eixo 1 Direita'),
  ('2x2x2', 'Eixo 2', 1, 'Eixo 2 Esquerda'),
  ('2x2x2', 'Eixo 2', 2, 'Eixo 2 Direita'),
  ('2x2x2', 'Eixo 3', 1, 'Eixo 3 Esquerda'),
  ('2x2x2', 'Eixo 3', 2, 'Eixo 3 Direita'),
  ('2x2x2 (rodado duplo)', 'Eixo 1', 1, 'Eixo 1 Esquerda Interior'),
  ('2x2x2 (rodado duplo)', 'Eixo 1', 2, 'Eixo 1 Esquerda Exterior'),
  ('2x2x2 (rodado duplo)', 'Eixo 1', 3, 'Eixo 1 Direita Interior'),
  ('2x2x2 (rodado duplo)', 'Eixo 1', 4, 'Eixo 1 Direita Exterior'),
  ('2x2x2 (rodado duplo)', 'Eixo 2', 1, 'Eixo 2 Esquerda Interior'),
  ('2x2x2 (rodado duplo)', 'Eixo 2', 2, 'Eixo 2 Esquerda Exterior'),
  ('2x2x2 (rodado duplo)', 'Eixo 2', 3, 'Eixo 2 Direita Interior'),
  ('2x2x2 (rodado duplo)', 'Eixo 2', 4, 'Eixo 2 Direita Exterior'),
  ('2x2x2 (rodado duplo)', 'Eixo 3', 1, 'Eixo 3 Esquerda Interior'),
  ('2x2x2 (rodado duplo)', 'Eixo 3', 2, 'Eixo 3 Esquerda Exterior'),
  ('2x2x2 (rodado duplo)', 'Eixo 3', 3, 'Eixo 3 Direita Interior'),
  ('2x2x2 (rodado duplo)', 'Eixo 3', 4, 'Eixo 3 Direita Exterior');
